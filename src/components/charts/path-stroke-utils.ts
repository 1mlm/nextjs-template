// biome-ignore-all lint/correctness/useExhaustiveDependencies: usePathStrokeMetrics takes its dependency list as a caller-supplied parameter, not a literal array
